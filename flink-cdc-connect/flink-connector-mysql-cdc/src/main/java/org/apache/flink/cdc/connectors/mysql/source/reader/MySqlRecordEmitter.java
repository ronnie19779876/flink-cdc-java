...
public class MySqlRecordEmitter<T> implements RecordEmitter<SourceRecords, T, MySqlSplitState> {
    ...
    protected void processElement(
        ...
        if (RecordUtils.isWatermarkEvent(element)) {
            ...
            updateRowCountForSplit(splitState, element);
    ...
    private void updateRowCountForSplit(MySqlSplitState splitState, SourceRecord element) {
        if (splitState.isSnapshotSplitState()) {
            MySqlSnapshotSplit split = splitState.asSnapshotSplitState().toMySqlSplit();
            RecordUtils.putRowCount(element, split.getRows());
        }
    }
